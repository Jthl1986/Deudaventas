...
url = "https://raw.githubusercontent.com/Jthl1986/T1/main/iipcAgo26.csv"
#iipcJul25.csv
...
def main():
    ...
    with st.expander("Metodología utilizada"):
        st.write("Para la deuda a valores constantes se multiplica deuda histórica de Nosis por Indices IPC Cobertura Nacional suministrado por INDEC, último informe Agosto 2026. Para deuda en dólares se divide deuda histórica de Nosis por dólar mayorista (cotización del último día hábil del mes en cuestión).")
